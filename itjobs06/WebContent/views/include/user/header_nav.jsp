...
<a href="index.html" class="navbar-brand"><img src="resources/images/logo1.png" style="width:160px;height:32px;" alt=""></a>
</div>
...
<li><a class="dropdown-item active" href="manage-resumes.html">Manage Resumes</a></li>
