 ...
 * Generated at: 2019-10-15 22:19:56 UTC
...
ArrayList<String> likeBoList = (ArrayList<String>)request.getAttribute("likeMem");
	...
	ArrayList<Notification> list=(ArrayList<Notification>)request.getAttribute("list");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"tag-type\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"heart-icon\" style=\"background:white; color:blue; text-align:center; padding-right: 132px;\">111\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" value=\"");
      out.print(n.getNoti_no());
      out.write("\" id=\"noNo5\" onchange=\"likeSum();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
...
if(!flag){  
	...
	if(currentPage<pi.getMaxPage()){ 
      ...
      out.write("<script>\r\n");
      out.write("\t\r\n");
      out.write("\tfunction likeSum(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar noNo = $('#noNo5').val();\r\n");
      out.write("\t\t\r\n");
