 ...
 * Generated at: 2019-10-16 03:03:41 UTC
...
if(mem== null || mem.getM_no() != n.getM_no() && !(mem.getType().equals("2"))){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h4>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a style=\"color:#00bcd4;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
	...
	if(mem!=null && (mem.getType().equals("2") || mem.getM_no()==n.getM_no())){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t지역: ");
      out.print(n.getAddress().split("\\+")[1].split(" ")[0] );
      out.write("\r\n");
	...
	if(mem!=null && (mem.getType().equals("2") || mem.getM_no()==n.getM_no())){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t희망연봉: ");
      out.print(n.getHope_salary().equals("4001")?"4000이상":n.getHope_salary().equals("0")?"회사내규에따름":n.getHope_salary() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
	}else{ 
      out.write("\r\n");
