 ...
 * Generated at: 2019-10-15 20:42:48 UTC
...
public final class resumeDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/include/user/mypage_menu.jsp", Long.valueOf(1571170324132L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(mem!=null){ 
      ...
      out.write("\r\n");
      out.write("\t<script>\r\n");
      out.write("\t\tvar page_header_title='이력서'\r\n");
      out.write("\t</script>\r\n");
	...
	Volunteer v=(Volunteer)request.getAttribute("v");
						...
						if(mem!=null && mem.getM_no()==re.getM_no()){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-common\" onclick=\"location.href='");
      out.print(request.getContextPath());
      ...
      out.write("\t\t\t\t\t<button class=\"btn btn-common\" onclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/deleteResum.re?resume_no=");
      out.print(re.getResume_no());
      ...
      out.write("\t\t\t\t\t<button class=\"btn btn-common\" onclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/pass.vo?v_no=");
      out.print(v.getV_no());
      out.write("'\">서류합격</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-common\" onclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/fail.vo?v_no=");
      out.print(v.getV_no());
      out.write("'\">서류탈락</button>\r\n");
      out.write("\t\t\t\t\t\t");
	}else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<h3>");
      out.print(v.getStatus() );
      out.write("상태의 이력서 입니다.</h3>\r\n");
      out.write("\t\t\t\t\t\t");
	} 
      out.write("\r\n");
      out.write("\t\t\t\t\t");
...
if(mem!=null && (mem.getType().equals("2") || mem.getM_no()==re.getM_no())){ 
	...
	if(mem!=null && (mem.getType().equals("2") || mem.getM_no()==re.getM_no())){ 
      ...
      out.print(re.getAddress().split("\\+")[1] );
      out.write("</span><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span><i class=\"lni-phone\"></i> ");
      ...
      out.write("\t\t\t\t\t\t\t\t<!-- <p class=\"sub-title\">UI/UX Designer</p> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>생년월일 : ****</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>이메일 : ****<br></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"address\"><i class=\"lni-map-marker\"></i> ****</span><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span><i class=\"lni-phone\"></i> ****</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <div class=\"social-link\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"Twitter\"><i class=\"lni-twitter-filled\"></i></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"facebook\"><i class=\"lni-facebook-filled\"></i></a>\r\n");
	...
	if(re.getCareer().equals("Y")){
      ...
      out.print(work[i]);
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"date\">일한 날짜: ");
	...
	if(re.getCertification()!=null && re.getCer_date()!=null){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"other item\">\r\n");
      out.write("\t\t\t\t\t\t\t<h3>기업로그인 하면 전체 조회 가능합니다.</h3>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
	} 
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
