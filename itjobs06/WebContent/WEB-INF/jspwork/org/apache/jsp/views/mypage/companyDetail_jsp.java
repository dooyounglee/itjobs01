 ...
 * Generated at: 2019-10-15 22:25:57 UTC
...
String likeCoCheck = (String)request.getAttribute(("likeCoCheck"));
	...
	Member co = (Member) request.getAttribute("co");
      ...
      out.write("\t\t\t\t\t<h3>설립일</h3>\r\n");
      out.write("\t\t\t\t\t<p>");
      out.print(co_info.getBirth_date().split(" ")[0] );
      out.write("</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<h3>");
      out.print(co_info.getAddress().split("\\+")[1]+ " " +co_info.getAddress().split("\\+")[2] );
      out.write("</h3>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<hr>\r\n");
 ...
 if(likeCoCheck == "1" ){ 
      out.write("  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"heart-icon\"> <img src=\"./resources/img/button-after.png\" class=\"likeimg\" style=\"height:200px; width:320px;\"> </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
 	}else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"heart-icon\"> <img src=\"./resources/img/button-before.png\" class=\"likeimg\" style=\"height:200px; width:320px;\"> </span>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
 	} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
	...
	String address=((Co_Info)request.getAttribute("co_Info")).getAddress();
      ...
      out.write("\t\t\t\t\t\t$(\".likeimg\").attr('src','./resources/img/button-after.png');\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$(\".likeimg\").attr('src','./resources/img/button-before.png');\t\t\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
