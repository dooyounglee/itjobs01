 ...
 * Generated at: 2019-10-14 07:38:28 UTC
...
ArrayList<String> likeResList = (ArrayList<String>)request.getAttribute("likeRes");
	...
	if(mem!=null && mem.getType().equals("2")){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print(n.getName().substring(0,1)+"**" );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
	} 
      out.write("\r\n");
	...
	if(mem!=null && mem.getType().equals("2")){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t지역: ");
      out.print(n.getAddress().substring(0,Math.min(7,n.getAddress().length()))+"..." );
      out.write("\r\n");
...
if(!flag){  
	...
	if(n.getCareer().equals("N")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a class=\"btn btn-common btn-xs\" style=\"padding: 6px 16px; font-size: 12px;\">신입</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
	}else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a class=\"btn btn-common btn-xs\" style=\"padding: 6px 16px; font-size: 12px;\">경력 ");
	...
	if(currentPage>1){ 
      ...
      out.print(request.getContextPath());
      out.write("/resumeList.se?currentPage=");
	...
	for(Resume r:list){
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\r\n");
      out.write("\t\t\tif(memNo!=null && memType != 1){ // 회원이 존재하면\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\tlikeimg.attr('src','./resources/img/like-after1.png');\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}); \r\n");
      out.write("\t\t\t\t}else if(memType==\"1\"){ // 일반회원끼리 좋아요 방지\r\n");
      out.write("\t\t\t\talert(\"일반회원끼리는 좋아요 불가능 합니다.\");\r\n");
      out.write("\t\t\t\t}else{\r\n");
