...
/**
 * Servlet implementation class AdminDeclareNotificationViewServlet
 */
@WebServlet("/get.de.no")
public class AdminDeclareNotificationViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminDeclareNotificationViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Declare de=new AdminDeclareService().getNotification(de_no);
		if(de!=null) {
