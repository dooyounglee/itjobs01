...
<a class="btn btn-common btn-sm" style="width:85px" onclick="history.back()">뒤로</a>
...
<div class="col-md-2">
<p><a class="btn btn-common btn-sm" style="width:85px" id="new" href="detail.re?resume_no=<%=v.getResume_no() %>">보기</a></p>
</div>
</div>
</div>
<%	} %>
